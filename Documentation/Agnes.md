...
## Notes
- User looking at dashboard asking about task names
- Second attempt succeded


## Evaluation
- Did you have any difficulties in creating the household?
	- Wasn't obvious that the household was created.
	- Delete Household button difficult to see on Tablet for certain users.
- Were there any confusing aspects about the process?
	- Not sure what a household is.
...
## Notes 
### Rooms
- Do kitchens get counted.
- Tried drop down to add rooms.
- Blue button attracted attention downwards.
- Maybe text box is too high?
- Attempted to enter names of room as a list in the input.

### Tasks
- Attempted to interact with assing tasks box.
- Didn't realise update had to be pressed.
- When a task is added the select should switch to that task.
- Feedback on update.
- Description used for assigning rooms.
...
- Did you have any difficulties with the process?
	- Felt things weren't immediately clear but could be figured out with a small amount of trial and error.
- Were there any confusing aspects about the process?
- Any other comments?
...
## Notes
- Add rule interface is squished on tablet.
- No feedback on create rule.
- Not immediately obvious where to go to enable.
- Sidebar may be too small for certain people.
...
## Notes
- Not obvious to click on user dashboard to view rota.
...
## Evaluation
- Did you have any difficulties with the process?
	- Didn't know what page to access.
- Were there any confusing aspects about the process?
- Any other comments?
...
## Notes
- Text is difficult to read (black on dark red).
...
- Did you feel like you needed much guidance to complete the tasks requested of you?
	- A good bit. It was ok once the user understood what the app was about.

- Did you feel as though the application was easy to navigate and achieve your goals?
	- Navigation was easy, however, there was difficulty in knowing where to go but this was possibly because the user wasn't sure what they were trying to do.
